		...
		if($this->email) {
			...
			foreach($result as $row) {
				...
				if($send) {
					...
					$precontent .= '<br>';
					$postcontent =  '<hr><br>' . Yii::t('BbiiModule.bbii', 'You can unsubscribe at any time by logging into the {forum site} and visit your forum profile page.', array('{forum site}' => Html::link(Yii::t('BbiiModule.bbii', 'website'), $url)));
