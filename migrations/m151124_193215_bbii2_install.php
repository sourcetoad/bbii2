...
class m151124_193215_bbii2_install extends Migration
{

    // Use safeUp/safeDown to run migration code within a transaction
    public function safeUp()
    {
        echo "m151124_193215_bbii2_install safeUp.\n";
    ...
    {
        echo "m151124_193215_bbii2_install reverting.\n";

        $connection = Yii::$app->getDb();
        $command    = $connection->createCommand("
            DROP TABLE `bbii_forum`;
            DROP TABLE `bbii_ipaddress`;
            DROP TABLE `bbii_member`;
            DROP TABLE `bbii_membergroup`;
            DROP TABLE `bbii_message`;
            DROP TABLE `bbii_post`
            DROP TABLE `bbii_setting`
            DROP TABLE `bbii_topic`
            DROP TABLE `bbii_topic_read`
            DROP TABLE `bbii_session`
            DROP TABLE `bbii_upvoted`
            DROP TABLE `bbii_poll`
            DROP TABLE `bbii_choice`
            DROP TABLE `bbii_vote`
            DROP TABLE `bbii_spider`
        ");
