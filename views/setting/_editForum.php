...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'cat_id', array('id'=>'label_cat_id')); ?>
			<?php echo $form->dropDownList($model,'cat_id',Html::listData(BbiiForum::model()->categories()->findAll(), 'id', 'name'), array('empty'=>'')); ?>
	...
	<div class="row">
		...
		<?php echo $form->dropDownList($model,'membergroup_id',Html::listData(BbiiMembergroup::model()->specific()->findAll(), 'id', 'name'), array('empty'=>'')); ?>
