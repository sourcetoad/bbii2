...
<tbody class = "forum">
	<tr>
		...
		<td rowspan = "2" style = "width:140px;">
			<?php echo Html::button(Yii::t('BbiiModule.bbii','Edit'), array('onclick' => 'js:editForum(' . $forumdata->id . ',"' . Yii::t('BbiiModule.bbii','Edit forum') . '", "' . Yii::$app->urlManager->createAbsoluteUrl('forum/setting/getforum') .'")')); ?>
