...
<div id = "bbii-wrapper">
	...
	<table class = "profile"><tr><td>
		...
		<tr>
			...
			<td>
				<?php if($model->contact_email && $this->module->userMailColumn) 	echo Html::a(Html::img($this->module->getRegisteredImage('User.png'), 'e-mail', array('title' => Yii::t('BbiiModule.bbii', 'Contact user by e-mail'))), array('member/mail', 'id' => $model->id)); ?>
				<?php if(isset($model->blogger)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Blogger.png'), 'Blogger', array('title' => 'Blogger')), $model->blogger, array('target' => '_blank')); ?>
				<?php if(isset($model->facebook)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Facebook.png'), 'Facebook', array('title' => 'Facebook')), $model->facebook, array('target' => '_blank')); ?>
				<?php if(isset($model->flickr)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Flickr.png'), 'Flickr', array('title' => 'Flickr')), $model->flickr, array('target' => '_blank')); ?>
				<?php if(isset($model->google)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Google.png'), 'Google', array('title' => 'Google')), $model->google, array('target' => '_blank')); ?>
				<?php if(isset($model->linkedin)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Linkedin.png'), 'Linkedin', array('title' => 'Linkedin')), $model->linkedin, array('target' => '_blank')); ?>
				<?php if(isset($model->metacafe)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Metacafe.png'), 'Metacafe', array('title' => 'Metacafe')), $model->metacafe, array('target' => '_blank')); ?>
				<?php if(isset($model->myspace)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Myspace.png'), 'Myspace', array('title' => 'Myspace')), $model->myspace, array('target' => '_blank')); ?>
				<?php if(isset($model->orkut)) 		echo Html::a(Html::img($this->module->getRegisteredImage('Orkut.png'), 'Orkut', array('title' => 'Orkut')), $model->orkut, array('target' => '_blank')); ?>
				<?php if(isset($model->tumblr)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Tumblr.png'), 'Tumblr', array('title' => 'Tumblr')), $model->tumblr, array('target' => '_blank')); ?>
				<?php if(isset($model->twitter)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Twitter.png'), 'Twitter', array('title' => 'Twitter')), $model->twitter, array('target' => '_blank')); ?>
				<?php if(isset($model->website)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Globe.png'), 'Website', array('title' => 'Website')), $model->website, array('target' => '_blank')); ?>
				<?php if(isset($model->wordpress)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Wordpress.png'), 'Wordpress', array('title' => 'Wordpress')), $model->wordpress, array('target' => '_blank')); ?>
				<?php if(isset($model->yahoo)) 		echo Html::a(Html::img($this->module->getRegisteredImage('Yahoo.png'), 'Yahoo', array('title' => 'Yahoo')), $model->yahoo, array('target' => '_blank')); ?>
				<?php if(isset($model->youtube)) 	echo Html::a(Html::img($this->module->getRegisteredImage('Youtube.png'), 'Youtube', array('title' => 'Youtube')), $model->youtube, array('target' => '_blank')); ?>
			</td>
		</tr>
		<tr>
			<td></td>
