...
<div id="bbii-footer">
	<div class="row">
		...
		<div class="statistics">
			...
			<div class="row">
				<span class="header"><?php echo Yii::t('bbii','Newest member'); ?></span> <?php $member = BbiiMember::find()->newest()->find(); echo CHtml::link($member->member_name, array('member/view', 'id'=>$member->id)); ?>
			</div>
		</div>
	</div>
</div>
