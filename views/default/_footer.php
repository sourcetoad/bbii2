		...
		<td class="online">
			<div>
				<span class="header2">
					<?php echo Yii::t(
						'BbiiModule.bbii',
						'{guests} guest(s) and {members} active member(s)',
						array('{guests}'=>($present - $members),'{members}'=>$members)
					);?>
				</span>
			...
			<div>
				...
				?>
				<?php echo Yii::t(
					'BbiiModule.bbii','({hidden} anonymous member(s))',
					array('{hidden}'=>BbiiMember::model()->hidden()->present()->count())
				); ?>
			</div>
		</td>
		<td class="statistics">
			...
			<tr>
				...
				<td><?php echo BbiiTopic::model()->count(); ?></td>
			</tr><tr>
				<th><?php echo Yii::t('BbiiModule.bbii','Total posts'); ?></th>
				<td><?php echo BbiiPost::model()->count(); ?></td>
			</tr><tr>
				<th><?php echo Yii::t('BbiiModule.bbii','Total members'); ?></th>
				<td><?php echo BbiiMember::model()->count(); ?></td>
			</tr><tr>
				...
				<td><?php echo BbiiSession::model()->count(); ?></td>
			</tr>
			</table>
		</td>
	</tr></table>
